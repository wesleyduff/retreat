...
class CabinsControllerTest < ActionController::TestCase
  ...
  test "should create cabin" do
    assert_difference('Cabin.count') do
      post :create, cabin: { available: @cabin.available, description: @cabin.description, max: @cabin.max, name: @cabin.name }
    end
  ...
  test "should update cabin" do
    patch :update, id: @cabin, cabin: { available: @cabin.available, description: @cabin.description, max: @cabin.max, name: @cabin.name }
    assert_redirected_to cabin_path(assigns(:cabin))
  end
